    ...
    <div className='container__footer'>
      <div className='col3 info'>
        ...
        <div className={'info__social_webs'}>
          <a className={'info__webs info__viber_div'} href=''> </a>
          <a className={'info__webs info__teleg_div'} href=''></a>
          <a className={'info__webs info__teleg_div'} href=''></a>
          <a className={'info__webs info__fb_div'} href=''></a>
        </div>
      </div>
        ...
        <div className='footer__sm'>
          ...
          <div className='info_sm'>
            ...
            <div className={'info__social_webs'}>
              ...
              <a className={'social_teleg'} href=''>
                <div className={'info__webs info__teleg_div'}></div>
              </a>
              <a className={'social_inst'} href=''>
                <div className={'info__webs info__inst_div'}></div>
              </a>
              <a className={'social_fb'} href=''>
                <div className={'info__webs info__fb_div'}></div>
              </a>
            </div>
            <div className='info_logo_sm'>
              <div className={'info__logo'}>
                <img className={'info__logo_img'} src={logo} alt='logo'/>
              </div>
              <div className={'info__text'}>
